...
const chartData = [
  { browser: "safari", visitors: 50, fill: "#ff5555" },
]
...
export default function MortalChart() {
  return (
    <Card className="flex flex-col col-span-2 bg-[#282c34] border-[#3d4452] text-white">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        ...
        <div className="text-muted-foreground leading-none">
          Showing Mortality Count for the last n months
        </div>
      </CardFooter>
    </Card>
  )
